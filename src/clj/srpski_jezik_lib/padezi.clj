  ...
  (let [broj-glasovnih-promeni (count vektor-glasovnih-promena)]
    (if (< indeks-trenutne-promene
      ...
      (let [[osnova-nakon-glasovne-promene
             nastavak-nakon-glasovne-promene] ((get
                                                 vektor-glasovnih-promena
                                                 indeks-trenutne-promene)
                                                rec
                                                nastavak)]
...
(def imenica-vlastita
     (str
       imenica
       " властита"))

(def imenica-vlastita-imena-ljudi
     (str
       imenica-vlastita
       " имена људи"))

(def imenica-vlastita-imena-zivotinja
     (str
       imenica-vlastita
       " имена животиња"))

(def imenica-vlastita-imena-geografskih-pojmova
     (str
       imenica-vlastita
       " имена географских појмова"))

(def imenica-vlastita-imena-nebeskih-tela
     (str
       imenica-vlastita
       " имена небеских тела"))

(def imenica-zajednicka
     (str
       imenica
       " заједничка"))
...
(def imenica-gradivna
     (str
       imenica
       " градивна"))

(def imenica-pluralia-tantum
     (str
       imenica
       " pluralia tantum"))
...
(def imenica-misaona-osecanje
     (str
       imenica-misaona
       " осећање"))

(def imenica-misaona-osobina
     (str
       imenica-misaona
       " особина"))

(def imenica-misaona-radnja-ili-stanje
     (str
       imenica-misaona
       " радња или стање"))     
